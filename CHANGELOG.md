...
## Upcoming
### Breaking
- Formatting of RP lines is done through a Liquid template (`_includes/rp_line.html`), instead of in Ruby code. You will need to add this include to your site. Running `rplogs update` will do it if you haven't made any style changes you want to keep. (See the [Updating](https://github.com/xiagu/jekyll-rp_logs#updating) section.) ([#57])
